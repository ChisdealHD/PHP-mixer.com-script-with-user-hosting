<?php 
	...
	$myintershow = $json['interactive'] == true ? 'YEY INTERACTIVE!!! <3' : 'No Interactive </3';
?>
...
<?php 
    ...
    $hosteeinter = $json123['interactive'] == true ? 'YEY INTERACTIVE!!! <3' : 'No Interactive </3';
    $beamid1 = $json123['id'];
	$intershow = $json123['interactive'] == true ? $hosteeinter : $myintershow;
?>
...
<body>
	...
	<h1><small id="Refresh"><?php echo "<br>Is there Interactive: $intershow</br>";?></small> </h1>
