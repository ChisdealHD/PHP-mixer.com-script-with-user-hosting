<?php 
	...
	$steam = $json['user']['social']['steam'];
	$instagram = $json['user']['social']['instagram'];
	$spreadshirts = $json['user']['social']['spreadshirt'];
...
<head>
    ...
    <title>ChisdealHD Social Media PAGE!!</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">ChisdealHD Social Media!
                    <small>Where Social Media kept!</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-md-8">
				...
				<h1><small><?php echo "<br>Facebook: $facebook</br>";?></small> </h1>
				<h1><small><?php echo "<br>Twitter: $twitter</br>";?></small>
                    <small><?php echo "<br>Discord: $discord</br>";?></small>
					<small><?php echo "<br>Youtube: $youtube</br>";?></small>
					<small><?php echo "<br>Steam: $steam</br>";?></small>
					<small><?php echo "<br>Soundcloud: $soundcloud</br>";?></small>
				</h1>
				</div>
            </div>

            <div class="col-md-4">
                <h1><small><?php echo "<br>Steam: $steam</br>";?></small> </h1>
				<h1><small><?php echo "<br>Soundcloud: $soundcloud</br>";?></small>
                    <small><?php echo "<br>Instagram: $instagram</br>";?></small>
					<small><?php echo "<br>Player.Me: $player</br>";?></small>
				</h1>
            </div>
