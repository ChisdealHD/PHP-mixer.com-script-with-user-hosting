...
<?php 
    ...
    $hosteeinter = $json123['token'];
    $beamid1 = $json123['id'];
	$intershow = $json123['online'] == true ? 'YEY INTERACTIVE!!! <3' : 'No Interactive </3';
?>
...
<body>
	...
	<iframe id="Refresh" src="https://beam.pro/embed/controls/<?php echo "$host";?>" width="1160" height="290"></iframe>
